...
#  Default: '/Library/Frameworks/Python.framework/Versions/3.9/share/jupyterhub'
# c.JupyterHub.data_files_path = '/Library/Frameworks/Python.framework/Versions/3.9/share/jupyterhub'
...
c.JupyterHub.hub_ip = '127.168.0.1'
c.JupyterHub.spawner_class = 'dockerspawner.DockerSpawner'
c.DockerSpawner.image = 'jupyterhub/singleuser:latest'

c.JupyterHub.ssl_cert = '/Users/user1/ssl-certs/jhubssl.crt'
c.JupyterHub.ssl_key = '/Users/user1/ssl-certs/jhubssl.key'

import sys
sys.path.insert(1, './lib')
import unity_jupyterhub_authenticator
from unity_jupyterhub_authenticator import UnityOAuthenticator

c.JupyterHub.authenticator_class = UnityOAuthenticator
c.OAuthenticator.oauth_callback_url = "https://127.168.0.1:8000/hub/oauth_callback"

# Please get the correct Unity Cognito user pool client ID and client secret from Unity CS team
c.OAuthenticator.client_id = "<COGNITO_CLIENT_ID>"
c.OAuthenticator.client_secret = "<COGNITO_CLIENT_SECRET>"

c.UnityOAuthenticator.login_service = "Unity Common Services"
c.UnityOAuthenticator.username_key = "username"

# Please get the correct Unity Cognito user pool domain name from Unity CS team
c.UnityOAuthenticator.authorize_url = "https://<DOMAIN_NAME>.auth.us-west-2.amazoncognito.com/oauth2/authorize"
c.UnityOAuthenticator.token_url = "https://<DOMAIN_NAME>.auth.us-west-2.amazoncognito.com/oauth2/token"
c.UnityOAuthenticator.userdata_url = "https://<DOMAIN_NAME>.auth.us-west-2.amazoncognito.com/oauth2/userInfo"
...
# This required for the custom authenticator
